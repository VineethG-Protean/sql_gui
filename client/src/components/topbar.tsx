...
const TopBar = () => {
  ...
  return (
    <div className="flex justify-between items-center px-8 py-3 border-b border-muted">
              ...
              <SheetDescription>
                <div className="flex flex-col gap-2 mt-4">
                  {sheetMenuItems.map((item, index) => (
                    ...
                    >
                      <div
                        className="flex gap-4 items-center cursor-pointer group hover:bg-muted transition-all duration-500 p-2 rounded-md"
                        key={index}
                      >
                        {item.icon}
